...
## How to Run
Once you have fulfilled the requirements, simply compile your C++ program and run the following command:
```
python3 run_sim.py ./<cpp_executable> <average service time>
```
